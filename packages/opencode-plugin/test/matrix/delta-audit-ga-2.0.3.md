...
4. **Interruption ordering — preserved with a revised runner.** On provider interruption the runner interrupts tool fibers before awaiting all tool fibers, retries interruption if the join fails, then records unsettled-tool and assistant failures. Citations: `@opencode/core@2.0.3/dist/chunks/mime-hf6kd63r.js:69-70,98-109,137-145`.
