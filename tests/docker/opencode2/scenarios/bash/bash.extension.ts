...
async function validate(context: HarnessValidationContext): Promise<void> {
  ...
  if (JSON.stringify(matrix.rows?.[0]?.trajectories) !== JSON.stringify({"T1":"expected_fail:https://github.com/anomalyco/opencode/issues/37164#tests/docker/opencode2/contract/probe/bash-t1-permission-refusal.txt","T2":"applicable","T3":"expected_fail:https://github.com/anomalyco/opencode/issues/37164#tests/docker/opencode2/contract/probe/bash-t1-permission-refusal.txt","T4":"expected_fail:https://github.com/anomalyco/opencode/issues/37164#tests/docker/opencode2/contract/probe/bash-t1-permission-refusal.txt","T5":"expected_fail:https://github.com/anomalyco/opencode/issues/37164#tests/docker/opencode2/contract/probe/bash-t1-permission-refusal.txt","T6":"expected_fail:https://github.com/anomalyco/opencode/issues/37164#tests/docker/opencode2/contract/probe/bash-t1-permission-refusal.txt","T7":"expected_fail:https://github.com/anomalyco/opencode/issues/48340"})) throw new Error("bash" + " applicability mismatch");
