...
pub(crate) use dead_code_projection::{
    ...
    project_dead_code_snapshot_with_revision, ProjectionCostEstimates, ProjectionKind,
    ProjectionVerdict, MAX_DELTA_BYTES,
};
#[cfg(test)]
pub(crate) use dead_code_projection::{
...
pub(crate) use crate::views::materialization::materialize_manifest_view_database;
...
pub(crate) fn set_meta_ready(conn: &Connection, ready: bool) -> Result<()> {
    conn.execute(
